...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        intarian_pepper_root = INTARIAN_PEPPER_ROOT("EMERALDS", 80, state)
        result[intarian_pepper_root.name] = intarian_pepper_root.get_orders()
